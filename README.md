...
- Model use this month: your top 3 models by credits, how many chat sessions used each, and each model's share. It counts every account's chats in this VS Code since its debug logs were turned on, GPT models included, and leaves out Copilot use elsewhere, like on github.com.
